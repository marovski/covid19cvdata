...
data.update <- function() {
  ...
  covid19cv <-
    utils::read.csv(
      "https://raw.githubusercontent.com/marovski/covid19cvdata/master/data-raw/csv/cvcovid19_raw.csv",
  ...
  if (flag) {
    x <-
      base::tolower(base::readline("Updates are available. Do you want to update? n/Y "))
